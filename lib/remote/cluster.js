...
var Cluster = exports.Cluster = function Cluster(spec) {
    ...
    var self = this,
        ...
        pingInterval = spec.pingInterval || NODELOAD_CONFIG.SLAVE_UPDATE_INTERVAL_MS;
    
    self.server = spec.server || HTTP_SERVER;
    self.masterEndpoint = new Endpoint(self.server, masterHost);
    self.slaves = new Slaves(self.masterEndpoint, pingInterval);
    self.slaveState_ = {};
    self.updateInterval = pingInterval * 4; // call update() every 4 ping intervals to check for slave aliveness
