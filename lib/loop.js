...
// -----------------------------------------
// 
// This file defines Loop (allows looping on an arbitrary function), and Scheduler (runs multiple
// Loop instances as a group).
//
...
handled as the loop executes. Loop emits the events 'start' (before the first iteration), 'end', 
'startiteration' and 'enditeration'.
