...
var DEFAULT_UPDATE_INTERVAL_MS = 2000;      // Number of milliseconds between 'update' events generated
                                            // by a LoadTest instance returned by run().
...
var LoadTest = exports.LoadTest = function LoadTest(tests) {
    ...
    var self = this;
    self.tests = tests;
    self.updateInterval = DEFAULT_UPDATE_INTERVAL_MS;
    self.interval = {};
    self.stats = {};
